...
def identity():
    ...
    True
    '''
    return Mat(({'x','y','u'},{'x','y','u'}), {(d,d):1 for d in {'x', 'y', 'u'}})
...
def translation(alpha,beta):
    ...
    True
    '''
    return Mat(({'x','y','u'},{'x','y','u'}), {('x', 'u'):alpha, ('y','u'):beta}) + identity()
...
def grayscale():
    ...
    '''
    return Mat(({'r','g','b'},{'r','g','b'}), {('b','b'):28/256, ('g','b'):28/256, ('r','b'):28/256, ('b','g'):151/256, ('g','g'):151/256, ('r','g'): 151/256, ('b','r'):77/ 256, ('g','r'):77/256, ('r','r'):77/256})
